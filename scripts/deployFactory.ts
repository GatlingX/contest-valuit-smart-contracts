...
async function main() {
  ...
  function sleep(ms: any) {
    ...
    let trexFactory = await TREXFACTORY.deploy(implementationAuth.address,"0x309188097F63a064310B00e514FD2a5D3cd7227c", "0x29C17871974e554EcCF13EAFF52ff3E516352e59");
